...
//     // });
//     secondObservable().pipe( mergeMap(data2 => of(`Вкладений subscribe new: ${data2}`)) )
//         .forEach(res => console.log(res));
// });

firstObservable.pipe( mergeMap(() => secondObservable()) )
    .subscribe(data2 => { console.log('Вкладений subscribe new:', data2); });